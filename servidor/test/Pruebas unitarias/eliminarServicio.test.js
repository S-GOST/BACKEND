// test/Pruebas unitarias/eliminarServicio.test.js
...
const { eliminarServicio } = require('../../controllers/serviciosController.js');
...
describe('eliminarServicio', () => {
  ...
  describe('Eliminación exitosa', () => {
    test('Debe devolver 200 y registrar la eliminación correctamente', async () => {
      ...
      Servicio.delete.mockResolvedValue();
      ...
      expect(Servicio.delete).toHaveBeenCalledWith(id);
  ...
  describe('Manejo de errores', () => {
    test('Debe devolver 500 si falla la eliminación en la base de datos', async () => {
      ...
      Servicio.delete.mockRejectedValue(dbError);
